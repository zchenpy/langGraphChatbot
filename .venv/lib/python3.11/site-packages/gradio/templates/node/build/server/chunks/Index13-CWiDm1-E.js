...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper } from './2-B4d9dQ-8.js';
...
const lang_map = {
  python: () => import('./index29-f8G4E4Qy.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-CIyO1bdc.js'),
      import('./frontmatter-D6I3h9Ue.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-DeA1I7Lq.js').then((m) => m.json()),
  html: () => import('./index31-Bm75e3ht.js').then((m) => m.html()),
  css: () => import('./index32-CPOng0Q3.js').then((m) => m.css()),
  javascript: () => import('./index33-XGqmIz46.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-XGqmIz46.js').then(
...
//# sourceMappingURL=Index13-CWiDm1-E.js.map
